export const ADD_BEST_PLAYER = 'ADD_BEST_PLAYER';
export const ADD_SUB_PLAYER = 'ADD_SUB_PLAYER';
export const REMOVE_BEST_PLAYER = 'REMOVE_BEST_PLAYER';
export const REMOVE_SUB_PLAYER = 'REMOVE_SUB_PLAYER';
